...
class Model(nn.Module):
    ...
    def reset_kv(self, max_request_num=15, max_cache_len=1024, head_num=32, head_size=128):
        self.stable_kv = None
        self.init_kv_cache(1, head_num, head_size, max_request_num, max_cache_len)
