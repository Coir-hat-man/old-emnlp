...
#更新相关的参数
    ...
    def draft_produce(self,hidden_states,MT,prune=True):  # produce draft sequence based on parallel decoding          
        ...
        cart_candidateslist, tree_candidateslist , tree_attn_masklist ,retrieve_indiceslist,node_num,weight_tensor=MT.quick_node_prune(medusa_logits,logits.squeeze(),[1 for _ in range(self.batch_size)],self.Node_num)
        self.weight_list+=weight_tensor.tolist()
        print("weight:",weight_tensor.tolist())
